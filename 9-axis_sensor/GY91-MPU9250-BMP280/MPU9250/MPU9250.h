...
#define CONFIG           0x1A // General Configuration
#define GYRO_CONFIG      0x1B // Gyro Full Scale Select
#define ACCEL_CONFIG     0x1C // Accel Full Scale Select
#define ACCEL_CONFIG2    0x1D // Accel Digital Low Pass Filter
...
#define ACCEL_XOUT_H     0x3B // Accel X Output High
#define TEMP_OUT_H       0x41 // Temperature Output High
#define GYRO_XOUT_H      0x43 // Gyro X Output High
...
typedef enum
{
  RANGE_16G          = 0b11, // 16g (default) --> State 3 
  RANGE_8G           = 0b10, // 8g --> State 2
  RANGE_4G           = 0b01,
  RANGE_2G           = 0b00
} accel_range;
