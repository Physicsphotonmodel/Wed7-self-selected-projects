...
The chips sold in online vendors like Aliexpress are the MPU9255, that is almost the same from MPU9250. The main diference for our porpoise is de ID, that is 0x71 for MPU9250 and 0x73 for MPU9255. So you need to change this ID in the header from Library (the default is for MPU9255). The difference between the two solutions is that de MPU9255 is for use within Automatic Activity Recognition library.
